...
namespace OpenTK_Hola_Mundo__Televisor_
{
    public class Game : GameWindow
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            GL.ClearColor(0.5f, 0.7f, 0.1f, 0.10f);

            televisores = new List<Clase_televisor>();

            // Añadir televisores a la lista
            televisores.Add(new Clase_televisor(new Vector3(0.15f, 0.10f, -1.0f), vbo_position, vbo_color, ibo_elements));
            televisores.Add(new Clase_televisor(new Vector3(0.1f, 0.20f, 1.0f), vbo_position, vbo_color, ibo_elements));
            televisores.Add(new Clase_televisor(new Vector3(-2.0f, 0.2f, -1.0f), vbo_position, vbo_color, ibo_elements));
            televisores.Add(new Clase_televisor(new Vector3(-4.0f, 0.4f, -1.0f), vbo_position, vbo_color, ibo_elements));
            televisores.Add(new Clase_televisor(new Vector3(-6.0f, 0.6f, -1.0f), vbo_position, vbo_color, ibo_elements));
            televisores.Add(new Clase_televisor(new Vector3(-8.0f, 0.8f, -1.0f), vbo_position, vbo_color, ibo_elements));
            televisores.Add(new Clase_televisor(new Vector3(-10.0f, 0.10f, -1.0f), vbo_position, vbo_color, ibo_elements));
            // camara = new Clase_camara(new Vector3(0.0f, 0.0f, 3.0f), Vector3.Zero, Vector3.UnitY);
